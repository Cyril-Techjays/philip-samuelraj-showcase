    ...
    <>
      ...
      <div className="min-h-screen" style={{ backgroundColor: '#F5F5F5' }}>
        ...
        <main className="pt-20 min-h-screen flex flex-col relative overflow-hidden">
          ...
          <div 
            className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-16 transition-transform duration-100 ease-out"
            style={{
              transform: `translate(-50%, 4rem) translate(${mousePosition.x}px, ${mousePosition.y}px)`
            }}
          >
            <img 
